...
private MongoClient mongoClient() {
    ...
    if (mongoClient == null) {
        mongoClient = MongoClients.create(
                MongoClientSettings.builder()
                        .applyConnectionString(new ConnectionString("mongodb://jobrunr:jobrunr123@docdb-2025-04-24-09-47-54.cluster-cjpre4alt9oy.us-east-1.docdb.amazonaws.com:27017/?replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false"))
                        .codecRegistry(codecRegistry)
                        .build());
